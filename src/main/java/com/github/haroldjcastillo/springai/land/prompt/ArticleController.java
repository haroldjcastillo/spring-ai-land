...
public class ArticleController {
  ...
  public String newPost(
    ...
    // A system message in LLMs is a special type of input that provides high-level instructions,
    // context, or behavioral
    // guidelines to the model before it processes user queries. Think of it as the
    // "behind-the-scenes"
    ...
    return chatClient
        .prompt()
        .user(spec -> spec.text("Write me a blog post about {topic}").param("topic", topic))
        .system(system)
        .call()
        .content();
  }
